...
/**
 * Controller-layer security and integration tests for POST
 * /api/payments/webhook.
 *
 * <p>
 * Uses a real WebhookSignatureVerifier bean and a mocked PaymentWebhookService
...
class PaymentWebhookControllerTest extends AbstractSecurityTest {
        ...
        void shouldReturn200WhenSignatureIsValid() throws Exception {
                ...
                doNothing().when(paymentWebhookService).processEvent(anyString(), anyString(), anyString(), anyLong(),
                                anyString());
        ...
        void shouldReturn200ForUnknownEventTypeAfterValidSignature() throws Exception {
                String unknownEventBody = "{\"event\":\"refund.created\"," +
                                "\"payload\":{\"payment\":{\"entity\":{" +
                                "\"id\":\"pay_refund_001\"," +
